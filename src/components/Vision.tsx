import { Body1, Body2, BodyHeadline, BuildPanelImage, Card, FridaysPanelImage, GovernPCenterImage, GovernPLeftImage, GovernPRightImage, Grid, Headline4, LearnIconsImage, LinkIcon, ShineImage, StarShineImage } from '@d_d/ui-components';
  ...
  return (
    <React.Fragment>
        ...
        <section className="justify-center items-center flex flex-col my-40">
          ...
          LEARN
           */}
              <Card noPadding className="col-start-1 col-end-7 border-primary-grey border-2 backdrop-blur-lg flex justify-between min-h-[320px]">
